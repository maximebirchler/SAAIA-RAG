...
## 2026-09-13 — A819/B : recherche littérale dans une révision observée

Protocole préenregistré au commit 58e3cca : tester B (outil explicite find_source_text), conserver la projection Writer actuelle ; C (mémoire centrée sur éléments) seulement après diagnostic distinct. B ne code ni recettes, ni créneaux, ni mots de test et ne choisit aucun outil automatiquement. Tenant/révision/hash/chemin vérifiés dans une transaction readonly snapshot ; pagination et identités canoniques préservées. Neuf contrôles protocole, deux PostgreSQL réels et suite backend 2 313 réussites passent. Diagnostic externe connu sur les vingt selectedItem de A817 : dix-neuf choix avec références exactes retrouvées, 58 chunks, 1 965 ms outils cumulés ; titre complet porridge sans match littéral, aucune absence corpus inférée. Zéro API nouveau. Premier pilote autonome B à figer puis exécuter, cap 0,75 USD, maximum deux pilotes / 1,50 USD ; sept appels/contextes/délais inchangés, HTTP une tentative. Produit TESTE_NON_APPROUVE. Détail dans documents/agent/comparaison-exploration-documentaire-a819-2026-09-13.md.

## 2026-09-13 — A819/B1 rejeté ; A820/B2 catalogue commun prêt

B1 candidat `9cfcd1e6`, job `23bac570-6337-4b79-8438-d3b5471ff505` : sept appels / 0,3793323 USD / 108,186 s provider / 28 recherches classiques, zéro lecture et zéro find, zéro cellule. Affirmation agrégée seize options / quatre manquantes non approuvée. Ancien faux principal search_corpus confirmé dans la requête réelle, bien que find visible. Ressources arrêtées, vrai GUID du manifeste contrôlé sans job non terminal. Solde calculé : 9,2540389 USD. Préenregistrement B2 au commit `7b1c45f` avant édition : les trois opérations au même niveau dans un catalogue commun Review/Writer et retrait des descriptions d'outil unique ; projection/outils/contextes/délais/appels inchangés. Suite backend 2 313 réussites et neuf contrôles protocole/catalogue passent. Prochain et dernier pilote B à figer puis lancer, cap 0,75 USD. Aucun succès autonome / blind / WinUI inféré ; TESTE_NON_APPROUVE.

## 2026-09-13 — A820 ponctuellement accepté ; A821 arrête la série ; A823 corrige le retour d'erreur

A820 produit vingt propositions distinctes, seize préparations et quatre fruits nature, avec vingt associations relues et dix-sept cartes physiques exactes. Ce n'est pas une preuve de vingt recettes. Six appels / 0,3304172 USD. La répétition A821 sur `c4a92279` échoue après quatre appels / 0,1577980 USD : demande de cinq pages inclusives pour un maximum de quatre, lot atomiquement rejeté avant exécution, motif non renvoyé au modèle. Troisième répétition non lancée ; aucune stabilité ou approbation produit inférée. A823 ajoute un retour d'arguments typé et une correction bornée dans les appels existants, sans exécuter ni élargir la demande invalide, sans modifier portée documentaire ou règles métier. Cinq nouveaux cas et suite backend 2 318 réussites passent, zéro échec, trois ignorés. Le prochain pilote doit repartir d'une nouvelle version figée, maximum sept appels / 0,75 USD / HTTP une tentative. Solde clos : 8,76582370 USD sur 40 USD achetés ; zéro nouvel achat. Détail : documents/agent/retour-des-erreurs-outils-a823-2026-09-13.md. Produit TESTE_NON_APPROUVE ; nouveau holdout et WinUI restent à valider.

## 2026-09-13 — A823 rejeté ; A824/C1 interface native préenregistrée et vérifiée

Le pilote réel A823 termine failed / advanced_critic_protocol_invalid : sept appels / 0,3645506 USD, 31 recherches, zéro read ou find. Le critique produit vingt objets dont onze vides sans preuve ; aucune réponse durable approuvée. Aucun cas de fenêtre invalide ne s'est présenté, donc récupération live A823 non démontrée. Ressources possédées arrêtées, zéro job possédé non terminal. Réapparition d'exploration insuffisante : arrêt des répétitions. Préenregistrement C1 au commit `332dd55d` avant implémentation : déclarer les mêmes trois fonctions à l'API pendant Writer/Critic, choix auto, retours liés et compacts, validations existantes, Planner/Review inchangés. Mode optionnel, désactivé par défaut. Quatorze nouveaux cas et suite Release 2 332 réussites passent, zéro échec, trois ignorés ; réservation inclut fonctions et historique. Premier pilote C1 à figer, cap 0,75 USD, deux pilotes maximum / 1,50 USD. Solde calculé : 8,40127310 USD sur 40 USD achetés. Détail : documents/agent/comparaison-interface-outils-native-a824-2026-09-13.md. TESTE_NON_APPROUVE conservé ; aucune sélection métier codée ni nouvel achat.
