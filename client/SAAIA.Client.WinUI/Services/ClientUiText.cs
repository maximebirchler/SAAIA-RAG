...
internal static class ClientUiText
{
    private static readonly Dictionary<string, Dictionary<string, string>> Catalog = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["admin.jobs.group.failed"] = Multi("Échecs et annulations", "Failed and canceled", "Fallidos y cancelados", "Falhados e cancelados", "Fehler und Abbrüche", "Falliti e annullati"),
