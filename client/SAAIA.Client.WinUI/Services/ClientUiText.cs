...
internal static class ClientUiText
{
    private static readonly Dictionary<string, Dictionary<string, string>> Catalog = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["admin.jobs.reset_filters"] = Multi("Réinitialiser les filtres", "Reset filters", "Restablecer filtros", "Repor filtros", "Filter zurücksetzen", "Reimposta filtri"),
        ["admin.jobs.empty_filtered"] = Multi("Aucun job ne correspond à ce filtre.", "No jobs match the current filters.", "Ningún trabajo coincide con los filtros actuales.", "Nenhum job corresponde aos filtros atuais.", "Keine Jobs entsprechen den aktuellen Filtern.", "Nessun job corrisponde ai filtri attuali."),
        ["admin.jobs.empty_filtered_hint"] = Multi("Des jobs existent dans d'autres statuts. Réinitialise les filtres pour tout revoir.", "Jobs exist in other statuses. Reset the filters to see everything again.", "Existen trabajos en otros estados. Restablece los filtros para verlo todo.", "Existem jobs em outros estados. Reponha os filtros para ver tudo.", "Es gibt Jobs in anderen Status. Setze die Filter zurück, um alles zu sehen.", "Esistono job in altri stati. Reimposta i filtri per vedere tutto."),
        ...
        ["admin.jobs.show_details"] = Multi("Détails", "Details", "Detalles", "Detalhes", "Details", "Dettagli"),
        ...
        ["admin.jobs.details.cancel_requested_flag"] = Multi("Annulation en cours", "Cancellation in progress", "Cancelación en curso", "Cancelamento em curso", "Abbruch läuft", "Annullamento in corso"),
        ["admin.jobs.details.enqueue_source"] = Multi("Origine", "Origin", "Origen", "Origem", "Herkunft", "Origine"),
        ...
        ["admin.jobs.details.doc_versions"] = Multi("Versions", "Versions", "Versiones", "Versões", "Versionen", "Versioni"),
        ["admin.jobs.details.auto_pause"] = Multi("Suivi automatique", "Automatic follow-up", "Seguimiento automático", "Acompanhamento automático", "Automatische Nachverfolgung", "Monitoraggio automatico"),
        ["admin.jobs.error.timeout"] = Multi("Délai dépassé pendant le traitement.", "The job timed out during processing.", "Se agotó el tiempo durante el procesamiento.", "Tempo esgotado durante o processamento.", "Zeitüberschreitung während der Verarbeitung.", "Tempo scaduto durante l'elaborazione."),
        ["admin.jobs.error.canceled_by_admin"] = Multi("Annulé par l'administrateur.", "Canceled by the administrator.", "Cancelado por el administrador.", "Cancelado pelo administrador.", "Vom Administrator abgebrochen.", "Annullato dall'amministratore."),
        ["admin.jobs.error.canceled_after_commit"] = Multi("Annulation détectée au moment de la finalisation.", "Cancellation detected during finalization.", "Se detectó la cancelación durante la finalización.", "Cancelamento detectado durante a finalização.", "Abbruch wurde bei der Finalisierung erkannt.", "Annullamento rilevato durante la finalizzazione."),
        ["admin.jobs.error.superseded"] = Multi("Job remplacé par une version plus récente du document.", "Job superseded by a newer document version.", "Trabajo sustituido por una versión más reciente del documento.", "Job substituído por uma versão mais recente do documento.", "Job wurde durch eine neuere Dokumentversion ersetzt.", "Job sostituito da una versione più recente del documento."),
        ["admin.jobs.auto_pause.on"] = Multi("mises à jour automatiques suspendues", "automatic updates paused", "actualizaciones automáticas en pausa", "atualizações automáticas em pausa", "automatische Aktualisierungen pausiert", "aggiornamenti automatici in pausa"),
        ["admin.jobs.auto_pause.off"] = Multi("mises à jour automatiques actives", "automatic updates active", "actualizaciones automáticas activas", "atualizações automáticas ativas", "automatische Aktualisierungen aktiv", "aggiornamenti automatici attivi"),
        ["admin.jobs.auto_pause.on_reason"] = Multi("mises à jour automatiques suspendues ({0})", "automatic updates paused ({0})", "actualizaciones automáticas en pausa ({0})", "atualizações automáticas em pausa ({0})", "automatische Aktualisierungen pausiert ({0})", "aggiornamenti automatici in pausa ({0})"),
        ...
        ["admin.jobs.enqueue_source.admin"] = Multi("Demande admin", "Admin request", "Solicitud admin", "Pedido admin", "Admin-Anfrage", "Richiesta admin"),
        ["admin.jobs.enqueue_source.api"] = Multi("API", "API", "API", "API", "API", "API"),
        ["admin.jobs.enqueue_source.scanner"] = Multi("Scanner documentaire", "Document scanner", "Escáner documental", "Scanner documental", "Dokumentenscanner", "Scanner documentale"),
        ["admin.jobs.enqueue_source.watcher"] = Multi("Surveillance fichiers", "File watcher", "Vigilancia de archivos", "Monitorização de ficheiros", "Dateiüberwachung", "Monitoraggio file"),
        ...
        ["admin.jobs.auto_pause.reason.admin_cancel"] = Multi("annulation admin", "admin cancellation", "cancelación admin", "cancelamento admin", "Admin-Abbruch", "annullamento admin"),
        ["admin.jobs.auto_pause.reason.repeated_failures"] = Multi("erreurs répétées", "repeated failures", "errores repetidos", "falhas repetidas", "wiederholte Fehler", "errori ripetuti"),
