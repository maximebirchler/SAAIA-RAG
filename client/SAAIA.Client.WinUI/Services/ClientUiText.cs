...
internal static class ClientUiText
{
    private static readonly Dictionary<string, Dictionary<string, string>> Catalog = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["admin.jobs.details.type"] = Multi("Famille", "Family", "Familia", "Família", "Familie", "Famiglia"),
        ["admin.jobs.details.job_type"] = Multi("Type métier", "Job type", "Tipo", "Tipo", "Jobtyp", "Tipo job"),
        ...
        ["admin.jobs.auto_pause.on"] = Multi("auto-pause active", "auto-pause active", "auto-pausa activa", "auto-pausa ativa", "Auto-Pause aktiv", "auto-pausa attiva"),
        ["admin.jobs.auto_pause.off"] = Multi("auto-pause inactive", "auto-pause inactive", "auto-pausa inactiva", "auto-pausa inativa", "Auto-Pause inaktiv", "auto-pausa inattiva"),
        ["admin.jobs.auto_pause.on_reason"] = Multi("auto-pause active ({0})", "auto-pause active ({0})", "auto-pausa activa ({0})", "auto-pausa ativa ({0})", "Auto-Pause aktiv ({0})", "auto-pausa attiva ({0})"),
