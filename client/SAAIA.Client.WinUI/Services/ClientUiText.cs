...
internal static class ClientUiText
{
    private static readonly Dictionary<string, Dictionary<string, string>> Catalog = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["admin.runtime.action.requalify.loading"] = Multi("Requalification runtime en cours...", "Runtime requalification in progress...", "Recalificación runtime en curso...", "Requalificação runtime em curso...", "Runtime-Neuqualifizierung läuft...", "Ririqualificazione runtime in corso..."),
        ["admin.runtime.action.requalify.done"] = Multi("Requalification terminée : {0} capacité(s), {1} qualifiée(s), {2} sélectionnée(s), {3} warmup result(s).", "Requalification completed: {0} capability(ies), {1} qualified, {2} selected, {3} warmup result(s).", "Recalificación completada: {0} capacidad(es), {1} cualificada(s), {2} seleccionada(s), {3} resultado(s) de warmup.", "Requalificação concluída: {0} capacidade(s), {1} qualificada(s), {2} selecionada(s), {3} resultado(s) de warmup.", "Neuqualifizierung abgeschlossen: {0} Fähigkeit(en), {1} qualifiziert, {2} ausgewählt, {3} Warmup-Ergebnis(se).", "Ririqualificazione completata: {0} capacità, {1} qualificata/e, {2} selezionata/e, {3} risultato/i warmup."),
        ["admin.runtime.action.requalify.failed"] = Multi("Impossible de lancer la requalification runtime.", "Could not start runtime requalification.", "No se pudo iniciar la recalificación runtime.", "Não foi possível iniciar a requalificação runtime.", "Runtime-Neuqualifizierung konnte nicht gestartet werden.", "Impossibile avviare la ririqualificazione runtime."),
        ...
        ["admin.runtime.action.open_b_quality"] = Multi("Ouvrir la revue qualité B", "Open B quality review", "Abrir revisión de calidad B", "Abrir revisão de qualidade B", "B-Qualitätsprüfung öffnen", "Apri revisione qualità B"),
        ["admin.runtime.quality.title"] = Multi("Revue qualité B", "B quality review", "Revisión de calidad B", "Revisão de qualidade B", "B-Qualitätsprüfung", "Revisione qualità B"),
        ["admin.runtime.quality.subtitle"] = Multi("Vue dédiée aux résumés B sous le seuil de qualité, avec agrégats et recommandations de revue.", "Dedicated view for B summaries below the quality threshold, with aggregates and review recommendations.", "Vista dedicada a los resúmenes B por debajo del umbral de calidad, con agregados y recomendaciones.", "Vista dedicada aos resumos B abaixo do limiar de qualidade, com agregados e recomendações.", "Dedizierte Ansicht für B-Zusammenfassungen unterhalb des Qualitätsschwellenwerts mit Aggregaten und Empfehlungen.", "Vista dedicata ai riepiloghi B sotto la soglia di qualità, con aggregati e raccomandazioni."),
        ...
        ["admin.runtime.quality.loading"] = Multi("Chargement de la revue qualité B…", "Loading B quality review…", "Cargando revisión de calidad B…", "A carregar a revisão de qualidade B…", "B-Qualitätsprüfung wird geladen…", "Caricamento revisione qualità B…"),
        ["admin.runtime.quality.load_failed"] = Multi("Impossible de charger la revue qualité B.", "Could not load the B quality review.", "No se pudo cargar la revisión de calidad B.", "Não foi possível carregar a revisão de qualidade B.", "B-Qualitätsprüfung konnte nicht geladen werden.", "Impossibile caricare la revisione qualità B."),
        ["admin.runtime.quality.empty"] = Multi("Aucun résumé B stocké n'est actuellement sous le seuil de qualité.", "No stored B summary is currently below the quality threshold.", "Ningún resumen B almacenado está actualmente por debajo del umbral de calidad.", "Nenhum resumo B armazenado está atualmente abaixo do limiar de qualidade.", "Derzeit liegt keine gespeicherte B-Zusammenfassung unter dem Qualitätsschwellenwert.", "Nessun riepilogo B archiviato è attualmente sotto la soglia di qualità."),
        ...
        ["admin.runtime.quality.metric.runtime_unavailable"] = Multi("Runtime indisponible", "Runtime unavailable", "Runtime no disponible", "Runtime indisponível", "Runtime nicht verfügbar", "Runtime non disponibile"),
        ...
        ["admin.runtime.quality.section.statuses"] = Multi("Répartition par statut runtime", "Breakdown by runtime status", "Desglose por estado runtime", "Distribuição por estado runtime", "Aufteilung nach Runtime-Status", "Ripartizione per stato runtime"),
    ...
    ["admin.jobs.list.title"] = Multi("Jobs admin", "Admin jobs", "Jobs admin", "Jobs admin", "Admin-Jobs", "Job admin"),
        ...
        ["settings.safe_note"] = Multi("Ces réglages sont sûrs : ils ne peuvent pas casser le RAG. Au pire, les réponses peuvent être plus lentes ou plus/moins détaillées.", "These settings are safe: they cannot break RAG. At worst, replies may be slower or more/less detailed.", "Estos ajustes son seguros: no pueden romper el RAG. Como mucho, las respuestas pueden ser más lentas o más/menos detalladas.", "Estas definições são seguras: não podem danificar o RAG. No máximo, as respostas podem ficar mais lentas ou mais/menos detalhadas.", "Diese Einstellungen sind sicher: Sie können RAG nicht beschädigen. Im schlimmsten Fall werden Antworten langsamer oder mehr/weniger detailliert.", "Queste impostazioni sono sicure: non possono rompere il RAG. Al massimo, le risposte possono essere più lente o più/meno dettagliate."),
        ...
        ["settings.support.open_folder"] = Multi("Ouvrir le dossier", "Open folder", "Abrir carpeta", "Abrir pasta", "Ordner öffnen", "Apri cartella"),
