...
internal static class ClientUiText
{
    private static readonly Dictionary<string, Dictionary<string, string>> Catalog = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["admin.jobs.cancel_done"] = Multi("Demande d'annulation envoyée.", "Cancel request sent.", "Solicitud de cancelación enviada.", "Pedido de cancelamento enviado.", "Abbruchanforderung gesendet.", "Richiesta di annullamento inviata."),
