...
public sealed partial class ToolAgentOrchestrator
{
    ...
    private static readonly string[] RuntimeToolNames =
    {
        ...
        "documents.extraction_quality",
        "documents.extraction_pages",
        "rag.search",
        "rag.multi_search",
        "rag.summarize_live",
        "sources.resolve",
    ...
    private ToolHandler CreateToolHandler(string toolName)
        => toolName switch
        {
            ...
            "documents.extraction_quality" => ExecDocumentsExtractionQualityAsync,
            "documents.extraction_pages" => ExecDocumentsExtractionPagesAsync,
            "rag.search" => ExecRagSearchAsync,
            "rag.multi_search" => ExecRagMultiSearchAsync,
            "rag.summarize_live" => ExecRagSummarizeLiveAsync,
            "sources.resolve" => ExecSourcesResolveV2Async,
            ...
            "admin.audit" => ExecAdminAuditAsync,
