...
public static class ToolManifest
{
    ...
    {
        new("documents.list", "user", "List indexed documents with pagination and optional filters.", Schema(("q", "string|null"), ("categoryPath", "string|null"), ("limit", "int"), ("offset", "int"))),
        new("documents.search", "user", "Search documents by name/path. Paginated.", Schema(("q", "string"), ("limit", "int"), ("offset", "int"))),
        ...
        new("documents.count", "user", "Count indexed documents globally or with filters.", Schema(("categoryPath", "string|null"), ("q", "string|null"))),
        new("documents.tree", "user", "Get the multi-level category tree for catalog structure exploration.", Schema(("path", "string|null"), ("depth", "int|null"), ("format", "json|markdown"), ("limit", "int|null"), ("offset", "int|null"))),
        new("documents.stats", "user", "Get inventory statistics for the indexed catalog.", Schema(("path", "string|null"))),
        new("documents.empty_count", "user", "Count empty folders on the server filesystem.", Schema(("path", "string|null"))),
        new("documents.empty_list", "user", "List empty folders on the server filesystem.", Schema(("path", "string|null"), ("limit", "int|null"), ("offset", "int|null"))),
        ...
        new("admin.summary.missing", "admin", "List indexed documents without a fresh stored summary.", Schema(("limit", "int"), ("offset", "int"), ("categoryPath", "string|null"))),
    ...
    public static string ToolbookText => string.Join("\n", new[]
    {
        ...
        "- Inventory requests (count/list/tree/stats/empty folders) are answered from indexed documents/catalog data, not from RAG chunks.",
