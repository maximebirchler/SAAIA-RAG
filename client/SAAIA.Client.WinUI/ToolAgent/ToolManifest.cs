...
public static class ToolManifest
{
    ...
    private static readonly ToolDefinition[] _definitions =
    {
        ...
        new("documents.get", "user", "Get document metadata for a document reference (index, docId, docPath, source label or exact file name).", Schema(("docRef", "string"))),
        ...
        new("rag.search", "user", "RAG retrieval for factual or technical questions. Returns snippets plus document/page references, source quality, headings, selection hints, profile signals and content-card evidence when available.", Schema(("query", "string"), ("topK", "int|null"), ("categoryPath", "string|null"), ("categoryRef", "string|null"), ("category", "string|null"), ("filters", "object|null"), ("mode", "auto|strict|standard"))),
        new("rag.multi_search", "user", "Multi-query retrieval with dedup/diversity for synthesis across several documents. Use complementary queries for broad requests, follow-up exploration and source diversity.", Schema(("queries", "string[]"), ("topK", "int|null"), ("categoryPath", "string|null"), ("categoryRef", "string|null"), ("category", "string|null"), ("filters", "object|null"), ("diversity", "double|null"), ("mode", "auto|strict|standard|null"))),
    ...
    public static string ToolbookText => string.Join("\n", new[]
    {
        ...
        "- Use sources.resolve only for explicit source/document references, source opening actions or 'where is source N' style questions.",
