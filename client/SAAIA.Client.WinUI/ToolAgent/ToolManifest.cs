...
public static class ToolManifest
{
    ...
    private static readonly ToolDefinition[] _definitions =
    {
        ...
        new("sources.resolve", "user", "Resolve an explicit source reference (e.g. source 34 or source of document 2). Use only when the user explicitly asks for a source, link, opening action or document/source reference.", Schema(("ref", "string|null"), ("pdfRef", "string|null"))),
        new("rag.search", "user", "RAG retrieval for factual or technical questions. Returns snippets with document/page references.", Schema(("query", "string"), ("topK", "int|null"), ("categoryPath", "string|null"), ("categoryRef", "string|null"), ("category", "string|null"), ("filters", "object|null"), ("mode", "auto|strict|standard"))),
        new("rag.multi_search", "user", "Multi-query retrieval with dedup/diversity for synthesis across several documents.", Schema(("queries", "string[]"), ("topK", "int|null"), ("categoryPath", "string|null"), ("categoryRef", "string|null"), ("category", "string|null"), ("filters", "object|null"), ("diversity", "double|null"), ("mode", "auto|strict|standard|null"))),
