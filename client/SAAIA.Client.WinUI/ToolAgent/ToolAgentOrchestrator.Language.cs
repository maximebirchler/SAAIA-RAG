...
public sealed partial class ToolAgentOrchestrator
{
    ...
    private static readonly Dictionary<string, string[]> LanguageSignals = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["it"] = new[] { "ciao", "grazie", "per favore", "io", "tu", "lei", "noi", "puoi", "puo", "dammi", "mostra", "cerca", "cerco", "consiglio", "consigli", "livelli", "parlano", "trova", "spiega", "cosa", "come", "quanti", "quante", "perche", "quale", "quali", "chi", "dove", "con", "senza", "per", "da", "su", "fonte", "fonti", "documento", "documenti", "pagina", "pagine", "rispondi", "italiano" }
    };
