...
public sealed partial class ToolAgentOrchestrator
{
    ...
    {
        ["fr"] = new[] { "bonjour", "salut", "coucou", "merci", "stp", "svp", "je", "tu", "vous", "nous", "peux", "pouvez", "donne", "explique", "montre", "trouve", "cherche", "comment", "combien", "pourquoi", "quoi", "qui", "quel", "quels", "quelle", "quelles", "ou", "avec", "sans", "pour", "dans", "sur", "entre", "source", "sources", "document", "documents", "page", "pages", "reponds", "francais", "est", "les", "des", "cette", "selon", "doit" },
        ...
        ["es"] = new[] { "hola", "gracias", "por favor", "yo", "tu", "usted", "puedes", "puede", "dame", "muestra", "busca", "busco", "consejo", "consejos", "puntos", "hablan", "explica", "encuentra", "que", "como", "cuantos", "cuantas", "por que", "cual", "cuales", "quien", "donde", "con", "sin", "para", "desde", "sobre", "fuente", "fuentes", "documento", "documentos", "pagina", "paginas", "responde", "espanol" },
        ["pt"] = new[] { "ola", "obrigado", "obrigada", "por favor", "eu", "tu", "voce", "podes", "pode", "da", "mostra", "procura", "procuro", "conselho", "conselhos", "pontos", "falam", "explica", "encontra", "que", "como", "quantos", "quantas", "porque", "qual", "quais", "quem", "onde", "com", "sem", "para", "desde", "sobre", "fonte", "fontes", "documento", "documentos", "pagina", "paginas", "responde", "portugues" },
        ["de"] = new[] { "hallo", "bitte", "danke", "ich", "du", "sie", "wir", "kannst", "konnen", "gib", "zeige", "suche", "hinweise", "darueber", "finde", "erklaere", "was", "wie", "wieviele", "warum", "welche", "wer", "wo", "mit", "ohne", "fur", "aus", "uber", "quelle", "quellen", "dokument", "dokumente", "seite", "seiten", "antworte", "deutsch", "mache", "wartung" },
        ["it"] = new[] { "ciao", "grazie", "per favore", "io", "tu", "lei", "noi", "puoi", "puo", "dammi", "mostra", "cerca", "cerco", "consiglio", "consigli", "livelli", "parlano", "trova", "spiega", "cosa", "come", "quanti", "quante", "perche", "quale", "quali", "chi", "dove", "con", "senza", "per", "da", "su", "fonte", "fonti", "documento", "documenti", "pagina", "pagine", "rispondi", "italiano", "valore", "predefinito", "secondo", "nella", "della", "delle", "sono", "viene" }
    };
