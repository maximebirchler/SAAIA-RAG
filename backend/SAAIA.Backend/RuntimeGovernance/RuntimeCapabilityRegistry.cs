...
internal static class RuntimeCapabilityRegistry
{
    ...
    [
        ...
        new("capability_c.retrieval_intelligence", "Capability C - Retrieval Intelligence", "C", "server-capability-c", false, false, "Capability C remains intentionally unimplemented in the v3.1 backend.")
    ];
