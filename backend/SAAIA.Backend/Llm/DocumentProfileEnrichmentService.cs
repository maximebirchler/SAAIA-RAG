...
Do not create cards from table-of-contents/index rows, category-only labels, difficulty/cost/time-only labels, dangling fragments, decorative layout text, or OCR noise.
Each card title must be standalone and precise enough to identify the content without surrounding page layout.
