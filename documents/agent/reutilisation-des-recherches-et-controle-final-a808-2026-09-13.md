...
## Essai réel après gel

Le job A808 `926b27aa-0384-40bd-a46a-832b4e3252cb`, sur le commit `333327d12a533fe63fcfcb9a15dc55ea177a647e`, termine techniquement avec succès mais répond `insufficient_documentation` : aucun choix, aucune carte et aucun planning. Les sept appels OpenAI réussissent, dont deux recherches tardives ordinaires et le critique ; 28 recherches documentaires sont enregistrées. Aucun appel de récupération de recherche répétée n'apparaît dans cette exécution. Ce dernier mécanisme reste couvert par les tests simulés, sans preuve d'exercice réel ici.

L'essai dure 75,721 secondes et coûte 0,32152050 USD. Le ledger cumule ensuite 28,90774280 USD, soit 1,09225720 USD calculé sur les 30 USD déjà achetés. `meal-a808-semantic-assessment.v1.json` rejette la livraison complète ; le message d'insuffisance ne prouve pas l'absence de recettes dans tout le corpus. La capture durable complète est conservée et hashée. Les processus de test sont arrêtés et les ports temporaires libérés après l'exécution.
